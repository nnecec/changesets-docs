...
export default defineConfig({
  ...
  head: [
    ...
    isProd && process.env.DATAPULSE_ID && [
      'script',
      {
        defer: 'true',
  ...
  themeConfig: {
    logo: '🦋',
    footer: {
      message: 'Built with ❤️ by <a href="https://github.com/nnecec" target="_blank">@nnecec</a>',
    ...
    editLink: {
      pattern: 'https://github.com/nnecec/changesets-docs/edit/main/website/:path',
    },
    search: {
      provider: 'local',
    }
